 ...
 *
 *   T3_ACCESS_TOKEN=... npx tsx test/smoke.live.mts [projectRootOrId] [harness] [model]
 */
import { Client } from "@modelcontextprotocol/sdk/client/index.js";
import { StdioClientTransport } from "@modelcontextprotocol/sdk/client/stdio.js";

const [projectArg = "C:\\code\\t3-turbo", harnessArg = "claudeAgent", modelArg = ""] = process.argv.slice(2);
...
await mustFail(
  "t3_create_thread",
  { project: project.id, harness: harnessArg, model, title: "x", prompt: "x", worktreePath: "C:\\definitely\\not\\a\\worktree" },
